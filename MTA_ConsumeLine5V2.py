...
# Variables
csv_file_path = 'Data_MTA_Line5.csv'
...
def callback(ch, method, properties, body):
    ...
    with open ('Data_MTA_Line5.csv', 'a', newline='') as file:
...
def main(hn: str = "localhost", qn: str = "Line-5_queue"):
